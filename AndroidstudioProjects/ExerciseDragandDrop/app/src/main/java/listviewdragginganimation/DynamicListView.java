...
public class DynamicListView extends ListView {
    ...
    private OnItemLongClickListener mOnItemLongClickListener =
            new OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                	Log.d("DynamicListView","LongClickListener - long clicked happened line 128");
                    mTotalOffset = 0;
    ...
    /* This is where you will update the database */
    private void swapElements(ArrayList arrayList, int indexOne, int indexTwo) {
    	Database db = new Database(this.getContext());
    	Log.d("DynamicListView","Moving " + indexOne + " to " + indexTwo);
        Object temp = arrayList.get(indexOne);
        db.swapExerciseNumbers(workoutId, indexOne, indexTwo);
    ...
    public void setWorkoutId(long wId){
    	workoutId=wId;
    }
